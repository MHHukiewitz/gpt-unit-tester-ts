...
def inline_code(base_path: Path, entry_file: str) -> str:
    """
    Inlines the code from the entry file and its imports into a single string.
    ...
    inline_file(base_path / entry_file)
    return "\n".join(code_blocks)
